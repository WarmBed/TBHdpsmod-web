...
const zhHant: Dict = {
  meta: {
    ...
    keywords: '塔斯克巴·英雄, 塔斯克巴英雄, TaskBarHero, Task Bar Hero, TBH, 塔斯克巴·英雄 DPS, 塔斯克巴·英雄 外掛, 塔斯克巴·英雄 傷害, TaskBarHero DPS, TaskBarHero mod, DPS 計算, 傷害統計, 傷害量表, 刷圖規劃, 寶箱記錄, 掉寶熱力圖, Steam 市集查價, BepInEx 外掛',
  },
