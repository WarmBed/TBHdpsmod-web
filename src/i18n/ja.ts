...
const ja: Dict = {
  ...
  featuresSub: '11のパネル、それぞれが1つの役割を持つ。キー1つでゲームに重ねて表示、クリック透過でプレイを妨げない。',
  features: [
    {
      tag: 'F1 · ハブ',
      title: 'コントロールセンター',
    ...
    },
    {
      tag: 'F8 · アイテム',
      title: 'アイテム統計',
      body: 'バックパック、倉庫、取引ストレージのすべてを集計（装備中のギアは除く）——スクロール可能な1つのリストで、アイテム1件につき1行、アイコン・レア度で色分けした名前・所持数を表示。',
      points: ['レア度とカテゴリでチップ絞り込み——組み合わせ可能、個数はもう一方のフィルターと連動して更新', 'アイテムごとにアイコン＋名前＋×N、同一アイテムは統合', 'レア度／カテゴリ／名前／アイコンは全オフライン・5言語対応；倉庫容量は開放済みタブを反映'],
    },
    {
      tag: 'F6 · プラン',
      title: '個人ファーミングプランナー',
