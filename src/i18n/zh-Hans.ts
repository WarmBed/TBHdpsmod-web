...
const zhHans: Dict = {
  ...
  featuresSub: '十一个面板各司其职。按一个键就叠在游戏上，点击穿透、不挡操作。',
  features: [
    {
      tag: 'F1 · 总控',
      title: '中控台',
    ...
    },
    {
      tag: 'F7 · 装备',
      title: '装备评分',
      body: '仿 WoW 装等的「战力一眼看」评分：每件装备依 稀有度＋装备等级＋词缀＋镶嵌数 计分，逐角色加总成总分，再拆成攻击／防御两个数字。',
      points: ['整队每角色总分＋⚔攻击／⛨防御拆分', '逐件：icon、稀有度上色、等级、镶嵌点、分数', '详细模式展开每件的逐效果计分明细'],
    },
    {
      tag: 'F8 · 物品',
      title: '物品统计',
      body: '统计你背包、仓库与交易仓里的所有物品（已穿装备不算）—— 一张可滚动清单，每件物品一行，附上 icon、稀有度上色名称与持有数量。',
      points: ['依稀有度与类别筛选 —— 可组合，数量会跟着另一个筛选交叉更新', '每件物品 icon＋名称＋×N，相同物品自动合并', '稀有度／类别／名称／icon 全离线、五语齐全；仓库容量反映你已开的分页'],
    },
    {
      tag: 'F6 · 规划',
      title: '个性化刷图规划',
